...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1815430601')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Heizanl:@tellicon.hpltxcm.mongodb.net//")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-100'))
QR_CODE = environ.get('QR_CODE', 'https://www.imghippo.com/i/zBHnF1724018527.jpg')
...
TUTORIAL = environ.get("TUTORIAL", "https://i.postimg.cc/B6xf6fDm/Screenshot-2024-08-19-12-03-35-82-c2c39eb77ce131054e1b7fd47705651e.jpg")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://i.postimg.cc/4NT4vkbm/IMG-20240819-025655-002.jpg")
